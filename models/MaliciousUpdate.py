...
class LocalWaterMarkUpdate(object):
    def __init__(self, args, dataset=None, idxs=None, attack=None, order=None):
        self.optimizer = None
        self.args = args
        self.loss_func = nn.CrossEntropyLoss()
        ...
        # backdoor task is changing attack_goal to attack_label
        self.attack_label = args.wm_label
        self.attack_goal = args.wm_goal
        ...
        self.trigger = args.wm_type
        self.triggerX = args.wm_triggerX
        self.triggerY = args.wm_triggerY
        self.watermark = None
        self.apple = None
        self.dataset = args.dataset
        if self.attack == 'dba':
    ...
    def train_malicious_badnet(self, net, test_img=None, dataset_test=None, args=None):
        ...
        if self.optimizer == None:
            ...
            net.parameters(), lr=self.args.global_lr, momentum=self.args.momentum)
        epoch_loss = []
